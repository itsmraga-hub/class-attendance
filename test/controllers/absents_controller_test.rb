...
class AbsentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create absent" do
    assert_difference("Absent.count") do
      post absents_url, params: { absent: { student_id: @absent.student_id, subject_date: @absent.subject_date, subject_id: @absent.subject_id } }
    end
  ...
  test "should update absent" do
    patch absent_url(@absent), params: { absent: { student_id: @absent.student_id, subject_date: @absent.subject_date, subject_id: @absent.subject_id } }
