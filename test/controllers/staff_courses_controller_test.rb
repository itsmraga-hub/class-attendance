...
class StaffCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create staff_course" do
    assert_difference("StaffCourse.count") do
      post staff_courses_url, params: { staff_course: { course_id: @staff_course.course_id, staff_id: @staff_course.staff_id } }
    end
  ...
  test "should update staff_course" do
    patch staff_course_url(@staff_course), params: { staff_course: { course_id: @staff_course.course_id, staff_id: @staff_course.staff_id } }
